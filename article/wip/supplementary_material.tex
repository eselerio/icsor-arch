...
The in-distribution accuracy export contains $13\times11\times5\times2=1{,}430$ surrogate--size--fold--prediction rows. Component and composite exports contain the corresponding 20-component and four-composite expansions. Tuning completed five 100-trial outer-fold studies and one separate 100-trial full-data study per surrogate, for 7,800 completed trials. The out-of-distribution benchmark used one full-data refit per surrogate and retained 600 mechanistic cases per regime.
...
Table~\ref{tab:s_full_hyperparameters} records the selected settings used for the final full in-distribution refits and out-of-distribution evaluation. These settings were selected in separate four-fold, 100-trial studies using only in-distribution data. Complete outer-fold selections, trial histories, sampler states, and study databases are retained under \path{results/article_final_v2/tuning/}.
...
\begin{itemize}
\item \path{metrics/id_fold_metrics.csv} and \path{metrics/id_fold_summary.csv} for aggregate in-distribution accuracy;
\item \path{metrics/id_component_metrics.csv} and \path{metrics/id_composite_metrics.csv} for component and composite in-distribution results;
...
\item \path{metrics/ood_metrics.csv}, \path{metrics/ood_component_metrics.csv}, \path{metrics/ood_composite_metrics.csv}, and \path{metrics/ood_physical_summary.csv} for out-of-distribution results; and

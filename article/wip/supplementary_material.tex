...
\midrule
\csvrowstwo{table_s_provenance.csv}
\bottomrule
\end{tabular}
\end{table}
...
\end{itemize}
All paths above are relative to \path{results/article_final_v2/}. Presentation CSVs and final PDF figures are retained beside the two article source files in \path{article/wip/}; result-derived assets are reproducible with \path{scripts/build_manuscript_revision_assets.py} and \path{scripts/build_component_nonnegativity_heatmap.py}.
